...
// node_modules/vitest/dist/vendor/base.dzu0Y6Hj.js
...
// node_modules/vitest/dist/vendor/vi.smj1Ggd4.js
...
// node_modules/vitest/dist/vendor/index.3iX2R_Z5.js
...
// src/use-cases/faAutenticacao.spec.ts
...
var FaAutenticacaoUseCase = class {
  constructor(faUsuarioRepository2) {
    this.faUsuarioRepository = faUsuarioRepository2;
  }
...
describe("FaAutenticacao use case", () => {
  ...
  it("Deve ser capaz de autenticar", async () => {
    ...
    globalExpect(faUsuario.id).toEqual(globalExpect.any(String));
  });
  it("N\xE3o deve ser poss\xEDvel autenticar com e-mail errado", async () => {
    await globalExpect(
      () => sut.execute({
        email: "johndoe@example.com",
        password: "123456"
