...
// src/use-cases/get-faUsuario-perfil.spec.ts
...
describe("Get User Profile Use Case", () => {
  ...
  it("Deve ser capaz de obter o perfil do usu\xE1rio", async () => {
    ...
    globalExpect(faUsuario.nome).toEqual("John Doe");
  });
  it("N\xE3o deve ser poss\xEDvel obter o perfil do usu\xE1rio com o ID errado", async () => {
    await globalExpect(
      () => sut.execute({
